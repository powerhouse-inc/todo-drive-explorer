...
export type ExtendedToDoListState = ExtendedState<ToDoListState, ToDoListLocalState>;
export type ToDoListDocument = PHDocument<ToDoListState, ToDoListLocalState, ToDoListAction>;
